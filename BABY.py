...
bot_token = '6367975283:AAHl8vnBZARkrLPTZFwum-ryXKYKKCa51j0'  # Replace with your bot token
...
ADMIN_ID = 1482759518  # Replace with the actual admin's user ID
...
def handle_contact_admin(message):
    bot.reply_to(message, f"📞 @BEASTxOFFICIAL: {ADMIN_ID}")
